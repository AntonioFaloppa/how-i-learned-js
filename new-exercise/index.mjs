import Friend from "./friends.mjs";
...
document.onreadystatechange = () => {
    ...
    const firstNameInput = buildInput("firstName", "text", "First Name");
    const lastNameInput = buildInput("lastName", "text", "Last Name");
    const birthdateInput = buildInput("birthdate", "date", "Birthdate");
    const colorInput = buildInput("color", "text", "Color");
    const catchPhraseInput = buildInput("catchPhrase", "text", "Catch Phrase");
    const container = document.createElement("div");
    container.classList.add("d-flex", "flex-column", "w-100", "align-items-center", "p-3");
    ...
    mainContainer.classList.add("d-flex", "flex-column");
...
function buildCard(friend) {
    ...
    const button = document.createElement("button");
    button.classList.add("btn", "btn-primary", "btn-succes");
